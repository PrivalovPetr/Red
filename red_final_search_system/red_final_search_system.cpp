...
void TestLargeData() {
	...
	vector<string> queries(50000);
	{
		LOG_DURATION("Generation")
		for (int i = 0; i < 5000; ++i)
			docs.emplace_back(GenDoc(100));


		for (int i = 0; i < 50000; ++i)
			queries.emplace_back(GenDoc(5));
	}
